...
#define MCX_SRC_INVISION  16  /**<  a source that approximates the MSOT invision tf-256 illumination geometry*/
#define MCX_SRC_ERROR_CHECKERBOARD  17  /**<  a source definition that reads the IPASC device metadata structure and approximates the therein defined illumination geometry in mcx */
#define MCX_SRC_ERROR_STRIPES  18  /**<  a source definition that reads the IPASC device metadata structure and approximates the therein defined illumination geometry in mcx */
#define MCX_SRC_ERROR_DIFFERENT  19
